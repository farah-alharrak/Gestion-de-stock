 ...
 * @author hp
 */
@WebServlet(name = "ListingByMarque", urlPatterns = {"/ListingByMarque"})
public class ListingByMarque extends HttpServlet {

    @EJB
    private ProduitFacadeLocal pr ;
    
    @EJB
    private MarqueFacadeLocal m ;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListingByMarque</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListingByMarque at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<!DOCTYPE html>");
            ...
            out.println("</header>");
            out.println("<main>");
            out.println("<form  action = \"http://localhost:8080/EntrepriseApplication1-war/ListingByMarque\" method = \"POST\"> ");
            out.println("Nom de la marque:");
            out.println("<br/>");            
            out.println("<input type=\"text\" name=\"NameM\" value =\"\" />");
            out.println("<br/>");            
            out.println("<input type=\"submit\" value =\"Afficher Produit\" />");
            out.println("</form>");        
            out.println("</body>");
            out.println("</html>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<!DOCTYPE html>");
            ...
            List<Produit> ListProduit = pr.findAllByMarque(request.getParameter("NameM"));
            
            out.println("<form  action = \"http://localhost:8080/EntrepriseApplication1-war/ListingByMarque\" method = \"GET\"> ");
