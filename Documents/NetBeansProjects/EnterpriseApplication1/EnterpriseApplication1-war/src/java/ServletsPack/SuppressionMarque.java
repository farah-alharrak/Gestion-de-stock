 ...
 * @author hp
 */
@WebServlet(name = "SuppressionMarque", urlPatterns = {"/SuppressionMarque"})
public class SuppressionMarque extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            // tu enleves le commentaire ayyoub
            
//            Boolean ret=m.supprimer(request.getParameter("RefProduit"));
//            if(ret==true)
//            {
...
//            }
            out.println("<form  action = \"http://localhost:8080/EntrepriseApplication1-war/SuppressionProduit\" method = \"GET\"> ");
        ...
        }catch(Exception e){System.out.println("Probleme dans la servlet de suppression de marque");}
    }
